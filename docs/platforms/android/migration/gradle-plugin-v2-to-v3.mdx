...
Current behavior (open-helper factory wrapping, Room DAOs, and `SQLiteDriver` scope) is documented on [Room and SQLite](/platforms/android/integrations/room-and-sqlite/) and [Gradle plugin configuration](/platforms/android/configuration/gradle/#tracing-auto-instrumentation).
